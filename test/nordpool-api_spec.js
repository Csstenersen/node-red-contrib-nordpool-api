...
const testNode = require('../nordpool-api.js')
...
describe('nordpool-api Node', function () {
  ...
  it('should be loaded', function (done) {
    const flow = [{ id: 'n1', type: 'nordpool-api', name: 'nordpool-api' }]
    helper.load(testNode, flow, function () {
      const n1 = helper.getNode('n1')
      n1.should.have.property('name', 'nordpool-api')
      done()
    })
  })
  ...
  it('should be able to receive data', function (done) {
    const flow = [
      { id: 'n1', type: 'nordpool-api', wires: [['n2']] },
      { id: 'n2', type: 'helper' }
    ]
    helper.load(testNode, flow, function () {
      const n1 = helper.getNode('n1')
  ...
  it('should have non-default settings', function (done) {
    const flow = [
      { id: 'n1', type: 'nordpool-api', area: 'DK2', currency: 'DKK', wires: [['n2']] },
      { id: 'n2', type: 'helper' }
    ]
    helper.load(testNode, flow, function () {
      const n1 = helper.getNode('n1')
